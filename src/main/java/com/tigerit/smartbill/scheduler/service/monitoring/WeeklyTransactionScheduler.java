...
import static com.tigerit.smartbill.common.values.APIValues.BillingServer.Scheduler.GENERATE_REPORT_WEEKLY;

@Slf4j
@Component
public class WeeklyTransactionScheduler {
	
	public boolean RunnableWeeklyTransaction() {
        log.info ("Entering Weekly Report generation task , Start Time " + LocalDate.now ());

        Object payload = null;

        String fullGET_URL = APIValues.BillingServer.Scheduler.SCHEDULER_CONTROLLER_BASE_PATH + GENERATE_REPORT_WEEKLY;
